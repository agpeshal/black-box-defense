...
class CURELearner():
    ...
    def _train(self, epoch, h):
        ...
        for batch_idx, (inputs, targets) in enumerate(self.trainloader):
            ...
            noise, _ = self._find_z(inputs, targets, h)
            ...
            noise = noise * align
            '''
            outputs_noise = self.net.eval()(inputs + self.radius * noise / self.std)
            # reg = self.criterion(outputs_noise, second_probable_class)
            reg = self.criterion(outputs_noise, targets)
