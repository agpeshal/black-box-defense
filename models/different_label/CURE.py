    ...
    def _train(self, epoch, h):
        ...
        for batch_idx, (inputs, targets) in enumerate(self.trainloader):
            ...
            for i in range(rep):
                ...
                outputs_pert = self.net.eval()(inputs + self.radius * noise / self.std)
                # reg = self.criterion(outputs_pert, second_probable_class)
                reg += self.criterion(outputs_pert, (targets+1)%10)
