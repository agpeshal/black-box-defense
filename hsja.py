...
parser.add_argument(
    "--batch_size", type=int, default=20, help="Training data batch size"
)
parser.add_argument("--model", default="base", type=str, help="model name to be loaded")
parser.add_argument("--iter", default=10, type=int, help="Number of HSJA iterations")
parser.add_argument("-seed", type=int, default=4, help="Seed for consistency")
...
trainloader, testloader = read_vision_dataset(
    "./data", batch_size=args.batch_size, transform=transform
)
net = ResNet18()
...
attack = fa.hop_skip_jump.HopSkipJump(
    steps=args.iter, max_gradient_eval_steps=1000, tensorboard=None
)
